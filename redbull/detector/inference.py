...
class SimDetector(Node):
    def __init__(self):
        ...
        # -------------------- Parameters --------------------
        self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/_0super_best_CenterSpeedDense_trainfree41561_20250817_004834_epoch_11_loss_1_63189.pt')   ### 이게 존나 베스트 
        ...
        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/CenterSpeedDense_dynamic_20250820_04%_epoch_56.pt')
        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/0_best_objfree_trainfree52497_20250818_170557_epoch_14_loss_088283.pt')  # 지금 이게 베스트 

        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/0_best_for_real_CenterSpeedDense_ft_from_e14_20250820_051040_epochTotal_15_val_0.009453.pt')
        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/CenterSpeedDense_transfer_real_t_20250820_164005_epoch14_epochTotal_74_val_0.232576.pt')

        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/CenterSpeedDense_transfer_real_onlyfree_t_20250820_170135_epoch14_epochTotal_15_val_3.121586.pt')
        # self.declare_parameter('model_path', 'src/TinyCenterSpeed/src/pt/CenterSpeedDense_transfer_real_onlyfree_t_20250820_170824_epoch14_epochTotal_38_val_4.015133.pt')

        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/CenterSpeedDense_transfer_no_free_t_20250820_182303_epoch14_epochTotal_22_val_0.722505.pt')  # 전이학습 real 12203개 
        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/Bottleneck_real_data_12203_t_20250820_1832_epoch_22.pt')
        ...
        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/0_best_for_real_CenterSpeedDense_ft_from_e14_20250820_051040_epochTotal_15_val_0.009453.pt')  
        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/CenterSpeedDense_transfer_real_corner_free514_t_20250820_172803_epoch14_epochTotal_21_val_0.012980.pt')
        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/CenterSpeedDense_transfer_real_corner_free514_t_20250820_172803_epoch14_epochTotal_21_val_0.012980.pt')   # 코너 전이학습 real
        # self.declare_parameter('model_path', '/home/harry/ros2_ws/src/TinyCenterSpeed/src/pt/CenterSpeedDense_transfer_real_t_20250820_163029_epoch14_epochTotal_15_val_1.233764.pt')
        # self.declare_parameter('model_path', 'src/TinyCenterSpeed/src/pt/1_redbull_objfree_trainfree24494_epoch_14_loss1_769234.pt')
        # self.declare_parameter('model_path', 'src/TinyCenterSpeed/src/pt/0_objfree_trainfree52497_20250817_141346_epoch_9_loss_079843.pt')
        ...
        # src/TinyCenterSpeed/src/pt/0_objfree_trainfree52497_20250817_141346_epoch_9_loss_079843.pt
        ...
        self.declare_parameter('odom_topic', '/car_state/odom') #'/ego_racecar/odom')  # base_link pose in map '/car_state/odom') 
        ...
        # Tracker params
        self.declare_parameter('gate_dist', 0.5)          # 같은 물체로 인정할 최대 거리[m]
        self.declare_parameter('min_hits', 3)             # 확정까지 필요한 연속 관측 수
        self.declare_parameter('max_missed', 15)          # 끊겨도 유지할 프레임 수
        self.declare_parameter('ema_alpha', 0.35)          # 좌표 EMA 계수
        ...
        try:
            from CenterSpeed import CenterSpeedDense, CenterSpeedDenseBottleneck, CenterSpeedBottleneckSENet
...
######################################
        ...
        with torch.no_grad():
            ...
            ender.record()
            torch.cuda.synchronize()
            infer_ms = (ender.elapsed_time(starter)) * 1000.0
