...
sim_detector_dayhe 코드 에서 토픽만 car_state/odom 으로 변경
"""
...
class SimDetector(Node):
    def __init__(self):
        ...
        self.declare_parameter('odom_topic', '/car_state/odom')  # /car_state/odom
        self.declare_parameter('scan_topic', '/scan')
        self.declare_parameter('marker_topic', '/marker_obstacles')
