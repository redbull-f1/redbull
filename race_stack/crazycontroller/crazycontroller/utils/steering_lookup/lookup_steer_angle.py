...
class LookupSteerAngle:
    ...
    LookupSteerAngle:
    """
    def __init__(self, lookup_table_path, logger):
      self.lu = np.loadtxt(lookup_table_path, delimiter=",")
      self.logger = logger
...
if __name__ == "__main__":
  detective =  LookupSteerAngle("/home/lmw/sim_ws/src/crazycontroller/crazycontroller/utils/RBC1/lookup_table.csv", print)
