...
public:
    GlobalWaypointsPublisher() : Node("global_waypoints_publisher")
    {
        ...
        this->declare_parameter<std::string>("csv_file", "Spielberg_map.csv");
        ...
        // Create publisher
        publisher_ = this->create_publisher<pl_msg::msg::WpntArray>("/global_waypoints", 10);
...
private:
    ...
    rclcpp::Publisher<pl_msg::msg::WpntArray>::SharedPtr publisher_;
    rclcpp::TimerBase::SharedPtr timer_;
    pl_msg::msg::WpntArray waypoints_msg_;
