...
class CrazyController(Node):
    def __init__(self):
        ...
        # Publishers
        self.publish_topic = '/drive'  # simulation
        ...
        # Publisher for steering and speed command (real car)
        ...
        self.create_subscription(Odometry, '/ego_racecar/odom', self.car_state_cb, 10)
