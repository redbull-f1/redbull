...
#include "spline_planner_dh_test/msg/ot_wpnt_array.hpp"
#include "spline_planner_dh_test/msg/frenet_debug.hpp"
#include "spline_planner_dh_test/msg/frenet_debug_array.hpp"
...
private:
    // Subscribers
    rclcpp::Subscription<spline_planner_dh_test::msg::ObstacleArray>::SharedPtr obstacles_sub_;
    rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr ego_odom_sub_;
    rclcpp::Subscription<spline_planner_dh_test::msg::WpntArray>::SharedPtr global_waypoints_sub_;
    
    // Publishers
    rclcpp::Publisher<spline_planner_dh_test::msg::OTWpntArray>::SharedPtr local_trajectory_pub_;
    ...
    rclcpp::Publisher<spline_planner_dh_test::msg::FrenetDebugArray>::SharedPtr frenet_debug_pub_;
    
    // Timer
    rclcpp::TimerBase::SharedPtr timer_;
    
    // Data members
    spline_planner_dh_test::msg::ObstacleArray::SharedPtr obstacles_;
    nav_msgs::msg::Odometry::SharedPtr ego_odom_;
    spline_planner_dh_test::msg::WpntArray::SharedPtr global_waypoints_;
    ...
    // Callbacks
    void obstacles_callback(const spline_planner_dh_test::msg::ObstacleArray::SharedPtr msg);
    void ego_odom_callback(const nav_msgs::msg::Odometry::SharedPtr msg);
    void global_waypoints_callback(const spline_planner_dh_test::msg::WpntArray::SharedPtr msg);
    ...
    std::vector<ObstacleFrenet> convert_obstacles_to_frenet(const spline_planner_dh_test::msg::ObstacleArray& obstacles);
    ...
    spline_planner_dh_test::msg::OTWpntArray generate_evasion_trajectory(const ObstacleFrenet& closest_obstacle);
    spline_planner_dh_test::msg::OTWpntArray generate_priority_based_evasion_trajectory(const std::vector<ObstacleFrenet>& obstacles);
    ObstacleFrenet select_primary_obstacle(const std::vector<ObstacleFrenet>& obstacles);
    spline_planner_dh_test::msg::OTWpntArray adjust_trajectory_for_influence_zone(
    ...
    // Visualization
    visualization_msgs::msg::MarkerArray create_trajectory_markers(const spline_planner_dh_test::msg::OTWpntArray& trajectory);
